"""Standalone diagnostic: `python -m jarvis calibrate-claps` prints the
...
from jarvis.voice.engines.clap_detector import peak
...
def run() -> None:
    ...
    from jarvis.config import CLAP_PEAK_THRESHOLD
    from jarvis.voice.wake_word import get_wake_word_engine
