...
The greeting is spoken directly from the hardcoded GREETING constant, never
generated by the model -- an LLM asked to "say this greeting" could
paraphrase or drop the ellipsis, which isn't acceptable for a phrase
specified verbatim.
"""
