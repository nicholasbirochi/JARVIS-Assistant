...
later -- not résumé data (resume/), not a code decision (see
roadmap.py for that). Stored as a flat JSON list under DATA_DIR,
...
def _reminders_path():
    from config import DATA_DIR  # live lookup -- monkeypatchable in tests
