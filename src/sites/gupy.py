"""First real SiteAdapter implementation -- see sites/base.py for why
...
def _is_authenticated(context) -> bool:
    ...
    is still present."""
    from config import GUPY_LOGIN_URL, GUPY_PORTAL_URL
...
class GupyAdapter(SiteAdapter):
    ...
    def login(self) -> bool:
        ...
        from config import GUPY_LOGIN_URL
    ...
    def inspect_current_profile(self) -> SiteProfileSnapshot:
        from config import GUPY_PROFILE_URL, SITES_HEADLESS
    ...
    def _start_application(
        ...
        if confirmed and company:
            from sites.application_profile import load_referral_contacts
