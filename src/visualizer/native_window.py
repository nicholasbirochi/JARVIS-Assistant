"""Real native window for the HUD (visualizer/server.py) via
...
Chromium `--app=` approach (visualizer/launcher.py, now unused)
...
UI work to happen there. menubar.py's click handlers already run
...
def is_open() -> bool:
    ...
    menubar.py to keep its menu item label truthful regardless of
