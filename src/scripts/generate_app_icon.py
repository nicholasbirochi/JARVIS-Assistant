...
(visualizer/page.html's constellation of connected dots), frozen
...
and committed as a static asset in assets/ -- no need to
...
ICNS_OUTPUT = Path(__file__).resolve().parent.parent / "assets" / "AppIcon.icns"
