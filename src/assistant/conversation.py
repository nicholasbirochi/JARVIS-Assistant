...
GREETING/CLAP_GREETING (config.py) are only spoken in text mode
...
tts.speak() itself, see voice/tts.py) is published to
visualizer/state.py -- purely a live visual aid (the menu bar's
