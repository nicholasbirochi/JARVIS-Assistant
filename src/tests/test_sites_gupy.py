...
from sites.base import PlannedFieldChange, SiteProfileSnapshot, UpdatePlan
from sites import application_profile
from sites.gupy import (
    GupyAdapter,
...
def test_continue_application_with_profile_fills_disponibilidade_inicio_imediato_from_the_resume(monkeypatch):
    ...
    from resume import store as resume_store
    from resume.schema import Availability, Bilingual, JobPreferences, PersonalInfo, Resume
